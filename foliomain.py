...
#print(pos)
nx.draw_networkx_edge_labels(G,pos,edge_labels=edge_labels,label_pos=.5,font_size=6,font_color='red')
nx.draw(G,pos, node_color =values ,with_labels=True, node_size=200,edge_color=edge_colors, connectionstyle=f'arc3, rad = {arc_rad}')
